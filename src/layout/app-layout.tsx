...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiLayers, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'developer', 'cluster-administrator', 'dev-ops-engineer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Cluster', path: '/clusters', entity: 'cluster', service: AccessServiceEnum.PROJECT, icon: FiLayers },
